...
{
    public class AdaRecruitmentBehavior : BehaviorBase
    {
        ...
        private bool ScanForBonfires(Companion ada)
        {
            int TileX = (int)(ada.Center.X * (1f / 16)),
                TileY = (int)(ada.Bottom.Y * (1f / 16));
            for(int x = -16; x < 16; x++)
            {
                for (int y = -8; y < 8; y++)
                {
